<template>
    <aside @mouseenter="expandSidebar" @mouseleave="collapseSidebar" :class="{ active: isSideBarActive }">
        
        <div :class="isSideBarActive ? 'expanded-logo' : 'collapsed-logo'" >
            <router-link to="/">
                <img :src="isSideBarActive ? '/src/assets/images/navbar-full-rich.png' : '/src/assets/images/navbar-rich.png'" 
                alt="로고" />
            </router-link>
        </div>

        <div class="menu">
            <div @click="toggleAssetMenu" class="button">
            ...
            <div @click="toggleIncomeMenu" class="button">
            ...
            <div @click="toggleInvestMenu" class="button">
            ...
            <div @click="toggleGoalMenu" class="button">
            ...
            <div @click="toggleCommunityMenu" class="button">
